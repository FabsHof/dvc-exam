...
def main(model=None, processed_data_path="./data/processed", model_path="./models"):
    ...
    logger.info(f'Loading best hyperparameters: {best_params}')
    ...
    model_path = os.path.join(processed_data_path, 'trained_model.pkl')
